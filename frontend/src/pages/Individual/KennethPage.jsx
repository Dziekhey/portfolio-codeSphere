...
>
      ...
      <div className="p-8">
        ...
        <div className="w-full mx-24 flex lgl:flex-row gap-10 lgl:gap-20">
          <div className="w-1/2 lgl:w-1/2">
            ...
            {
            kenfirstskills.length>0 && kenfirstskills.map((data) => (<SkillCard key={data._id} skills={data}/>))
            }
            </div>
          </div>
          <div className="w-1/2 lgl:w-1/2">
            ...
            <div className="w-full lgl:w-1/2">
            {
              kensecondskills.length>0 && kensecondskills.map((data) => (<SkillCard key={data._id} skills={data}/>))
            }
            </div>
          </div>
        </div>
      ...
      <div className="p-8 border-t-4 border-black">
        ...
        <div className="flex justify-center space-x-10 font-medium py-4">
          <span size="small" className='hover:scale-105 cursor-pointer'><ion-icon name="mail-outline"></ion-icon>antwikenneth14@gmail.com</span>
          <span size="small" className='hover:scale-105 cursor-pointer'><ion-icon name="call-outline"></ion-icon>+23350137612</span>
          <span size="small" className='hover:scale-105 cursor-pointer'><ion-icon name="location-outline"></ion-icon>Spintex, Ghana</span>
        </div>
