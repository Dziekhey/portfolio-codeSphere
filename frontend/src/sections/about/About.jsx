...
text-gray-800 font-extrabold pb-6 sm:w-4/6 w-5/6 mx-auto  mt-8">The Talented Team Members</h1>
        </div>
      </div>
      <div className="w-full bg-gray-100 px-10 pt-10">
        <div className="mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 md:grid-cols-2 items-center xl:justify-between  md:justify-around sm:justify-around lg:justify-around">
            <div className="w-full md:w-1/2 relative mt-16 mb-32 sm:mb-24
            ">
